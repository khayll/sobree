      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Page setup", link: "/api/page-setup/" },
            { label: "Zone editing (headers/footers)", link: "/api/zone-editing/" },
            { label: "Presence (remote cursors)", link: "/api/presence/" },
            { label: "Y.Doc wire API", link: "/api/ydoc/" },
